...
class Commander(wx.Frame):
    ...
    def __init__(self, parent, ser, debug = False):
        ...
        self.lt_vert = wx.Slider(self, -1, 0, -100, 100, wx.DefaultPosition, (-1, 200), wx.SL_VERTICAL | wx.SL_LABELS)
        lt_joySizer.Add(self.lt_vert,(0,0),wx.GBSpan(3,1))
        self.center_lt_joy = wx.Button(self, -1, label="Center joystick")
        self.center_lt_joy.Bind(wx.EVT_BUTTON, self.centerLeftjoy)
        lt_joySizer.Add(self.center_lt_joy,(0,2),wx.GBSpan(1,1), wx.ALIGN_RIGHT)
        lt_joySizer.Add(wx.StaticText(self, -1, "Horizontal"),(1,1), wx.GBSpan(1,2),wx.ALIGN_BOTTOM | wx.ALIGN_CENTER_HORIZONTAL)
        self.lt_hor = wx.Slider(self, -1, 0, -100, 100, wx.DefaultPosition, (200, -1), wx.SL_HORIZONTAL | wx.SL_LABELS)
        ...
        self.rt_vert = wx.Slider(self, -1, 0, -100, 100, wx.DefaultPosition, (-1, 200), wx.SL_VERTICAL | wx.SL_LABELS)
        rt_joySizer.Add(self.rt_vert,(0,0),wx.GBSpan(3,1))
        self.center_rt_joy = wx.Button(self, -1, label="Center joystick")
        self.center_rt_joy.Bind(wx.EVT_BUTTON, self.centerRightjoy)
        rt_joySizer.Add(self.center_rt_joy,(0,2),wx.GBSpan(1,1), wx.ALIGN_RIGHT)
        rt_joySizer.Add(wx.StaticText(self, -1, "Horizontal"),(1,1), wx.GBSpan(1,2),wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_BOTTOM)
        self.rt_hor = wx.Slider(self, -1, 0, -100, 100, wx.DefaultPosition, (200, -1), wx.SL_HORIZONTAL | wx.SL_LABELS)
    ...
    def onTimer(self, event=None):
        # configure output
        send_buttons = self.getButtons()
        self.sendPacket(self.rt_vert.GetValue(), self.rt_hor.GetValue(), self.lt_vert.GetValue(), self.lt_hor.GetValue(), send_buttons)
